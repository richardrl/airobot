...
class Robotiq2F140RtdeReal:
    ...
    def is_active(self):
        ...
        return Robotiq2F140RtdeReal.GripperStatus(status) == Robotiq2F140RtdeReal.GripperStatus.ACTIVE
    ...
    def auto_calibrate(self, log=True):
        ...
        if Robotiq2F140RtdeReal.ObjectStatus(status) != Robotiq2F140RtdeReal.ObjectStatus.AT_DEST:
    ...
    def move_and_wait_for_pos(self, position, speed, force):  # noqa
        ...
        while Robotiq2F140RtdeReal.ObjectStatus(cur_obj) == Robotiq2F140RtdeReal.ObjectStatus.MOVING:
            cur_obj = self._get_var(self.OBJ)
