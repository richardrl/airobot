...
class SingleArmPybullet(ARM):
    ...
    def get_ee_pose(self):
        ...
        """
        info = self._pb.getLinkState(self.robot_body_id, self.ee_link_id)
        pos = info[4]
        quat = info[5]
    ...
    def get_ee_vel(self):
        ...
        """
        info = self._pb.getLinkState(self.robot_body_id,
                                     self.ee_link_id,
    ...
    def compute_ik(self, pos, ori=None, ns=False, *args, **kwargs):
        ...
        if ori is not None:
            ...
            jnt_poss = self._pb.calculateInverseKinematics(self.robot_body_id,
                                                           self.ee_link_id,
                                                           pos,
                                                           ori,
                                                           **ex_args)
    ...
    def reset_joint_state(self, jnt_name, jpos, jvel=0):
        ...
        """
        self._pb.resetJointState(self.robot_body_id,
